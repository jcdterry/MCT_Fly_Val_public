### This script builds and fits the model: PAL_TP.Briere_Comp.BH_Err.Norm
 ## Last built on:2023-12-14 11:55:04.076128
 ## Author Chris Terry
...
PAL_TP.Briere_Comp.BH_Err.Norm_fit <- brm(MODEL, data =  LaggedFemales_PAL,
prior = PRIORS, chains=4,cores =4, iter=4000)
 PAL_TP.Briere_Comp.BH_Err.Norm_fit <- add_criterion(PAL_TP.Briere_Comp.BH_Err.Norm_fit,criterion = c("loo", "waic"))

FIT <- PAL_TP.Briere_Comp.BH_Err.Norm_fit 
save(PAL_TP.Briere_Comp.BH_Err.Norm_fit , file ="../AutoModels/Fits/FEMS_PAL_TP.Briere_Comp.BH_Err.Norm")
 print(Sys.time())
